        ...
        <div className="glass-card rounded-2xl p-8 space-y-6">
          ...
          <Tabs defaultValue="password" className="w-full">
            <TabsList className="grid w-full grid-cols-2">
              <TabsTrigger value="password">{t("auth.tab.password")}</TabsTrigger>
              <TabsTrigger value="otp">{t("auth.tab.otp")}</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="password" className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="loginPassword">{t("signup.password")}</Label>
                <div className="relative">
                  <Input
                    id="loginPassword"
            ...
            <TabsContent value="otp" className="space-y-4 mt-4">
              {!otpSent ? (
                <>
                  <div className="space-y-2">
                    <Label htmlFor="otpEmail">{t("auth.email")}</Label>
                    <Input
                      id="otpEmail"
                      type="email"
                      placeholder="your@email.com"
                ...
                <>
                  <p className="text-sm text-muted-foreground text-center">
                    {t("auth.otp.check")} <strong>{otpEmail}</strong>
                  </p>
