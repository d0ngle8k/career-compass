...
const SignUpPage = () => {
  ...
  const handleSignUp = async () => {
    if (!displayName.trim() || !email.trim() || !password || !confirmPassword) {
      toast.error(t("signup.fill.all"));
      return;
    }
    if (password.length < 6) {
      toast.error(t("signup.password.min"));
      return;
    }
    if (password !== confirmPassword) {
      toast.error(t("signup.password.mismatch"));
      return;
    }
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={loading || !email.trim() || !password || !confirmPassword || !displayName.trim()}
            >
              {loading ? (
