...
print("\n=== TEST CASE 51 - Testing /api/v1/ai/generate-email ===")

# Test BOTH endpoints
for endpoint in ['/api/v1/content/generate-email', '/api/v1/ai/generate-email']:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if result.get('success'):
                metadata = result.get('data', {}).get('extracted_metadata', {})
                print(f"  Recipient: {metadata.get('recipient', 'N/A')}")
        else:
